  ...
  <div style="height: 100%;" :key="data.pageKey">
    ...
    <el-scrollbar height="80vh">
      <el-space wrap :key="key_val">
        <div v-if="menu===null">
          <img src="../../assets/noData.jpg" alt="暂无数据" sizes="large" style="width:50%;position: absolute;  top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);"/>
        </div>
        <el-card v-for="item in menu" :key="key_val" class="box-card"
        ...
        >
          ...
          <el-descriptions-item align="center">
            <template #label>
              ...
              {{ detail_show_dish.value.dishIntroduction }}
          </el-descriptions-item>
          <el-descriptions-item align="center">
            <template #label>
              <div class="cell-item">
        ...
        <div>
          ...
          >
            ...
            <el-form-item label="菜品名称" prop="dishName" class="item">
              <el-input style="width: 50%;" v-model="change_menu.dishName" disabled></el-input>
            </el-form-item>
            ...
            <el-form-item label="菜品价格" prop="dishPrice" class="item">
              <el-input v-model.number="change_menu.dishPrice" style="width: 30%" disabled></el-input>
            </el-form-item>
            <el-form-item label="菜品现价" class="item">
              <el-input v-model.number="change_menu.dishNowprice" style="width: 30%" disabled></el-input>
            </el-form-item>
            <el-form-item label="菜品分类" prop="dishType" class="item">
              <el-select v-model="change_menu.dishType" class="m-2" placeholder="Select" size="large" disabled>
                <el-option
